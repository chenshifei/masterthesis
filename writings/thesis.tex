...
\begin{algorithm}[h]
  \SetAlgoLined
  \KwIn{Translation hypothesis $H$, source language embeddings $E_s$, target language embeddings $E_t$, distance threshold $D$}
  \KwResult{Updated translation hypothesis $H^\prime$ with words being replaced by their neighbors in the desired language}
